...
class CreateUserForm extends Component {
    ...
    render( ) {
        ...
        const { isAuthenticated, loadingUser, pristine, loginError } = this.props
...
function mapStateToProps( state ) {
    return { isAuthenticated: state.loginDuck.isAuthenticated, errorAuthenticating: state.loginDuck.errorAuthenticating, loadingUser: state.loginDuck.loadingUser, loginError: state.loginDuck.loginError };
}
...
const form = reduxForm({ form: 'createuserForm', asyncValidate, validate });
